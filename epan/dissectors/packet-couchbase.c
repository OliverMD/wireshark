  ...
  case PROTOCOL_BINARY_CMD_SET_WITH_META:
    if (request) {
      ...
      if (extlen == 28 || extlen == 30) {
        ...
        proto_tree_add_bitmask(extras_tree, tvb, offset, hf_meta_options, ett_extras_flags, extra_flags,
                               ENC_BIG_ENDIAN);
        offset += 4;
      }
...
proto_register_couchbase(void)
{
  static hf_register_info hf[] = {
    ...
    { &hf_exptime, {"Exptime", "couchbase.extras.exptime", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL} },
    { &hf_extras_meta_seqno, {"Seqno", "couchbase.extras.meta.seqno", FT_UINT64, BASE_HEX, NULL, 0x0, NULL, HFILL} },
    { &hf_confres, {"ConfRes", "couchbase.extras.confres", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL} },
  };
